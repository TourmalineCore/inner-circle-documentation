...
10. Добавить все поля, которых не хватает в доке, но они уже есть в реализации: tenant_id, deleted_at_utc и т.д. Поддержка тенантов согласно https://learn.microsoft.com/en-us/ef/core/miscellaneous/multitenancy, для кейса хранения колонки `TenantId` в каждой таблице.
