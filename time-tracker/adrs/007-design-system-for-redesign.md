# 007: Choice of Design System for IC Redesign
...
- React + Vite
- SCSS for styling
- custom component implementations with inconsistent design patterns

Key requirements:
- unified visual language across all services
- high accessibility standards
- centralized management and distribution of design system
- minimal disruption to existing codebase
- support for existing Sass infrastructure
- ability to gradually migrate services

## Decision
Use  React Aria UI unstyled components and distribute via npm package.
...
4. React Aria ecosystem is actively maintained by Adobe, so more reliable approach.

5. React Aria documentation contains expamples of styles, which we can copy be used to spend less time on styling from scatch. 
...
## Alternatives
### Headless design systems (TanStack)
...
shadcn/ui is a popular copy-paste component library built on Radix UI with Tailwind CSS.
Excellent for new projects without existing styles, but creates significant friction in our React + Sass environment.

#### Advantages
- ready-to-use styled components
- minimal bundle size — only components you copy into your project
- full code ownership — you can modify any component logic
...
| **a11y (Accessibility)** | Top‑tier accessibility. Designed with accessibility as a primary priority. Wins on mobile a11y. | Excellent accessibility. |
  ...
  <tbody>
    <tr>
      ...
      <td valign="top">
        ...
        No network latency or risk of remote module unavailability.
      </td>
      <td valign="top">
    ...
    <tr>
      ...
      <td valign="top">
        ✅ shadcn/ui: public examples and libraries (prompt-ui-components, micropods)<br>
